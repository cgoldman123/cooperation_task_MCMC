...
fit_results = '/media/labs/rsmith/lab-members/cgoldman/Wellbeing/cooperation_task/data_analysis/compiled_model_fits_VB/coop_fits_prolific_8-22-24_untransformed.csv'
results = sys.argv[1]
...
with open(fit_results, newline='') as csvfile:
    ...
    for subject in file:
        ...
        os.system(f'sbatch -J {jobname} -o {stdout_name} -e {stderr_name} {ssub_path} {results} {experiment_mode} {subject["id"]} {subject["posterior_alpha"]} {subject["posterior_eta"]} {subject["posterior_omega"]} {subject["posterior_opt"]} {subject["posterior_cr"]} {subject["posterior_cl"]}') 
...
###python3  /media/labs/rsmith/lab-members/cgoldman/Wellbeing/cooperation_task/scripts/cooperation_task_scripts_MCMC_CMG/run_coop_MCMC_simfit.py  /media/labs/rsmith/lab-members/cgoldman/Wellbeing/cooperation_task/modeling_output/coop_MCMC_model_output/coop_MCMC_simfit_using_VB_params_8-27/ "prolific"
